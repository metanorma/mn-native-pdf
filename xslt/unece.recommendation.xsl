		...
		<fo:root xmlns:fo="http://www.w3.org/1999/XSL/Format" font-family="Times New Roman, FreeSerif, HanSans, NanumGothic, DroidSans" font-size="10.5pt" xml:lang="{$lang}">
			<fo:layout-master-set>
				...
				<fo:simple-page-master master-name="document" page-width="{$pageWidth}" page-height="{$pageHeight}">
					<fo:region-body margin-top="26mm" margin-bottom="10mm" margin-left="30mm" margin-right="19mm"/>
			...
			<fo:page-sequence master-reference="cover-page" force-page-count="no-force">				
				<fo:flow flow-name="xsl-region-body">
					...
					<fo:block font-weight="bold" text-align="right" font-size="14pt" margin-top="104pt" margin-bottom="12pt">
					...
					<fo:block margin-bottom="11pt" >&#xA0;</fo:block>
					<fo:block text-align="center" line-height="115%">
			...
			<!-- Preface Pages -->
			<fo:page-sequence master-reference="document" force-page-count="no-force" line-height="115%">
				...
				<fo:flow flow-name="xsl-region-body" line-height="115%">
					<fo:block>
						<fo:block font-weight="bold" margin-bottom="12pt">Note </fo:block>
						...
						<fo:block font-weight="bold" text-align="center" margin-bottom="12pt">The United Nations Centre for Trade Facilitation and Electronic Business (UN/CEFACT)</fo:block>
						<fo:block font-weight="bold" text-align="center" margin-bottom="12pt">Simple, Transparent and Effective Processes for Global Commerce</fo:block>
						...
						<fo:block margin-bottom="12pt">Participation in UN/CEFACT is open to experts from United Nations Member States, Intergovernmental Organizations and Non-Governmental Organizations recognised by the United Nations Economic and Social Council (ECOSOC). Through this participation of government and business representatives from around the world, UN/CEFACT has developed a range of trade facilitation and e-business standards, recommendations and tools that are approved within a broad intergovernmental process and implemented globally.</fo:block>
						<fo:block text-align="center" margin-bottom="12pt">www.unece.org/cefact</fo:block>
					</fo:block>
					<fo:block-container border="3pt solid black" margin-bottom="12pt">
						<fo:block text-align="center">ECE/TRADE/437</fo:block>
					</fo:block-container>
	...
	<xsl:template match="un:title">
		...
		<xsl:choose>
			...
			<xsl:when test="ancestor::un:sections or (ancestor::un:annex and $level &gt;= 2)">
				<fo:block id="{$id}" font-size="{$font-size}" font-weight="bold" space-before="3pt" margin-bottom="12pt" margin-left="-9.5mm" keep-with-next="always" line-height="14.5pt"> <!-- text-indent="-9.5mm" -->
