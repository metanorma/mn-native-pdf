						...
						<fo:block-container margin-top="18mm" id="firstpage_id_{$num}">
							...
							<fo:block font-family="Arial" text-align="justify">
								<fo:block>
									...
									<xsl:apply-templates select="/mn:metanorma/mn:preface/mn:abstract/node()[not(self::mn:fmt-title)] | 
												/mn:metanorma/mn:preface/mn:clause[@id = '_abstract' or normalize-space(mn:fmt-title) = 'Abstract']/node()[not(self::mn:fmt-title)]"/>
								</fo:block>
								<fo:block>&#xa0;</fo:block>
								<fo:block>
									<fo:inline font-weight="bold">Keywords: </fo:inline>
...
<!--
	...
	<xsl:variable name="Image-IEEE-Logo-black-svg">
		<svg xmlns:dc="http://purl.org/dc/elements/1.1/" xmlns:cc="http://creativecommons.org/ns#" xmlns:rdf="http://www.w3.org/1999/02/22-rdf-syntax-ns#" xmlns:svg="http://www.w3.org/2000/svg" xmlns="http://www.w3.org/2000/svg" id="svg25" height="10.93mm" width="38.099998mm" version="1.0">
			<defs id="defs9">
				<clipPath id="clipEmfPath1" clipPathUnits="userSpaceOnUse">
	...
	<xsl:template name="insert_Image-IEEE2-Logo-svg">
		...
		<svg xmlns:dc="http://purl.org/dc/elements/1.1/" xmlns:cc="http://creativecommons.org/ns#" xmlns:rdf="http://www.w3.org/1999/02/22-rdf-syntax-ns#" xmlns:svg="http://www.w3.org/2000/svg" xmlns="http://www.w3.org/2000/svg" id="svg65" height="63.240002mm" width="110.48mm" version="1.0">
			<defs id="defs9">
				<clipPath id="clipEmfPath1" clipPathUnits="userSpaceOnUse">
	...
	<xsl:variable name="Image-Blue-Boxes-svg">
		<svg xmlns:dc="http://purl.org/dc/elements/1.1/" xmlns:cc="http://creativecommons.org/ns#" xmlns:rdf="http://www.w3.org/1999/02/22-rdf-syntax-ns#" xmlns:svg="http://www.w3.org/2000/svg" xmlns="http://www.w3.org/2000/svg" id="svg59" height="164.32001mm" width="112.51mm" version="1.0">
			<defs id="defs9">
				<clipPath id="clipEmfPath1" clipPathUnits="userSpaceOnUse">
