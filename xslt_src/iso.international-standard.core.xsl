...
<xsl:stylesheet xmlns:xsl="http://www.w3.org/1999/XSL/Transform" 
																...
																<fo:block text-align="left" margin-top="2mm">
																	...
																	<xsl:for-each select="/iso:metanorma/iso:bibdata/iso:copyright/iso:owner/iso:organization">
																		<xsl:choose>
																			...
																			<xsl:when test="iso:name = 'ICC'">
																				<fo:external-graphic src="{concat('data:image/png;base64,', normalize-space($Image-ICC-Logo))}" content-height="{$content-height}mm" content-width="scale-to-fit" scaling="uniform" fox:alt-text="Image ICC Logo"/>
																			</xsl:when>
																			<xsl:otherwise></xsl:otherwise>
																		</xsl:choose>
																		<xsl:if test="position() != last()">
	...
	<xsl:variable name="Image-ICC-Logo">
		<xsl:text></xsl:text>
	</xsl:variable>
