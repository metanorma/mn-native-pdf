...
<xsl:stylesheet xmlns:xsl="http://www.w3.org/1999/XSL/Transform" 
	...
	<xsl:template name="insertCoverPageCommon">
		...
		<!-- BIPM logo -->
		<fo:block-container absolute-position="fixed" left="11.8mm" top="12mm"> <!-- left="12.8mm" top="12.2mm" -->
			<fo:block>
				...
				<fo:instream-foreign-object content-width="37mm" fox:alt-text="Image Logo" fox:placement="Block">
		...
		<fo:block-container absolute-position="fixed" left="166.5mm" top="253mm">
			<fo:block>
				<fo:instream-foreign-object content-height="32mm" content-width="32mm" fox:alt-text="Image Logo" fox:placement="Block">
	...
	<xsl:template name="insert_Logo-BIPM-Metro">
		<fo:block-container absolute-position="fixed" left="47mm" top="67mm">
			<fo:block>
				<fo:instream-foreign-object content-width="118.6mm" fox:alt-text="Image Logo" fox:placement="Block">								
