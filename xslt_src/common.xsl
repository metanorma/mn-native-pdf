...
<xsl:stylesheet xmlns:xsl="http://www.w3.org/1999/XSL/Transform" 
	...
	<!-- external parameters -->
	<xsl:param name="syntax-highlight">false</xsl:param>
	...
	<xsl:variable name="titles_">
		...
		<title-edition lang="en">
			<xsl:choose>
				<xsl:when test="$namespace = 'bsi' or $namespace = 'iso' or $namespace = 'iec' or $namespace = 'itu' or $namespace = 'unece' or $namespace = 'unece-rec' or $namespace = 'nist-cswp'  or $namespace = 'nist-sp' or $namespace = 'csd' or $namespace = 'iho' or $namespace = 'mpfd' or $namespace = 'bipm' or $namespace = 'jcgm'">
		...
		<title-toc lang="en">
			<xsl:if test="$namespace = 'csd' or $namespace = 'iho' or $namespace = 'mpfd' or $namespace = 'ogc' or $namespace = 'unece-rec'">
	...
	<xsl:template match="*[local-name() = 'p'][@type = 'floating-title' or @type = 'section-title']" priority="2" mode="contents">
		<xsl:variable name="level">
			<xsl:call-template name="getLevel">
...
<!-- ========== -->
	...
	<!-- eref -->	
	<!-- ====== -->
	<!-- get all hidden bibitems to exclude them from eref processing -->
	...
	<xsl:template match="*[local-name() = 'references'][not(@normative='true')]/*[local-name() = 'bibitem']" priority="2">
		...
		<xsl:choose>
			...
			<xsl:otherwise> <!-- $namespace = 'csd' or $namespace = 'gb' or $namespace = 'iec' or $namespace = 'iso' or $namespace = 'jcgm' or $namespace = 'm3d' or 
	...
	<xsl:template name="processBibitem">
		...
		<xsl:choose>
			...
			<!-- for csd, iec, iso, m3d, mpfd, and other  -->
			<xsl:otherwise>
	...
	<xsl:template match="*[local-name() = 'bibitem']/*[local-name() = 'note']" priority="2">
		<fo:footnote>
			<xsl:variable name="number">
				<xsl:choose>
					<xsl:when test="$namespace = 'bipm' or $namespace = 'csa' or $namespace = 'csd' or $namespace = 'ogc' or $namespace = 'ogc-white-paper' or $namespace = 'rsd'">
						<xsl:choose>
