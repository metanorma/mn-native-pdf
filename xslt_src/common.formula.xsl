...
<xsl:stylesheet xmlns:xsl="http://www.w3.org/1999/XSL/Transform" 
	...
	<xsl:template match="mn:fmt-stem/mn:semx/text()[normalize-space() = ''] |
			mn:fmt-stem/text()[normalize-space() = ''] |
			text()[preceding-sibling::*[1][self::mn:fmt-stem]][following-sibling::*[1][self::mn:bookmark]][normalize-space() = '']" priority="3"/>
